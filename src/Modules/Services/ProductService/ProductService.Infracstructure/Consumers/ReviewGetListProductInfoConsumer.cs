...
{
    public class ReviewGetListProductInfoConsumer : IConsumer<GetListProductInfoRequest>
    {
        private readonly IProductRepository _productRepository;

        public ReviewGetListProductInfoConsumer(IProductRepository productRepository)
        {
