...
{
    public class GetCartBySessionIdQueryHandler : IQueryHandler<GetCartBySessionIdQuery, CartDTO>
    {
        private readonly ICartRepository _cartRepository;
        private readonly ICartService _cartService;
        private readonly IMapper _mapper;

        public GetCartBySessionIdQueryHandler(ICartRepository cartRepository, ICartService cartService, IMapper mapper)
        {
        ...
        public async Task<Result<CartDTO>> Handle(GetCartBySessionIdQuery request, CancellationToken cancellationToken)
        {
