...
namespace CustomerService.Application.Abtractions
{
    public interface IJwtTokenService
    {
        ...
        Task<Result<IDictionary<string, RedisValue>>> GetSessionAsync(int userId, string deviceId);

        Task<Result> SaveSessionAsync(int userId, string deviceId, string accessToken, string refreshToken);
