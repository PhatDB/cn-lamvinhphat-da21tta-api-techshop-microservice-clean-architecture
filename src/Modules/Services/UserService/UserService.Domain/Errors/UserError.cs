...
namespace UserService.Domain.Errors
{
    public static class UserError
    {
        ...
        public static readonly Error UsernameEmpty =
            Error.Validation("User.UsernameEmpty", "Username cannot be empty.");

        public static readonly Error UsernameDuplicate =
            Error.Validation("User.UsernameDuplicate", "Username already exists.");

        public static readonly Error EmailEmpty =
            Error.Validation("User.EmailEmpty", "Email cannot be empty.");
        ...
        public static readonly Error UserInactive =
            Error.Conflict("User.Inactive", "User is inactive.");

        public static readonly Error UserAlreadyActive =
            Error.Conflict("User.AlreadyActive", "User is already active.");

        public static readonly Error UserAddressNotFound =
            Error.NotFound("User.AddressNotFound", "User address not found.");

        public static readonly Error UserAddressDuplicate =
            Error.Validation("User.AddressDuplicate", "User address already exists.");

        public static readonly Error PhoneNumberEmpty =
            Error.Validation("User.PhoneNumberEmpty", "Phone number cannot be empty.");

        public static readonly Error PhoneNumberInvalid =
            Error.Validation("User.PhoneNumberInvalid", "Phone number is invalid.");
    }
}